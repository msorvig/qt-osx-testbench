...
const QMetaObject FragmentToy::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FragmentToy.data,
      qt_meta_data_FragmentToy,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FragmentToy::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FragmentToy.stringdata0))
        return static_cast<void*>(const_cast< FragmentToy*>(this));
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< FragmentToy*>(this));
